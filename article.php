                ...
                ?>
                    <article>
                        <header>
                            ...
                            <!-- 标题 -->
                            <h2><a href="view.php?ID=<?php echo $row['ID']; ?>"><?php echo stripslashes($row['title']) ?></h2>
                        </header>
                        <!-- 封面 -->
                        <a href="view.php?ID=<?php echo $row['ID']; ?>" class="image fit"><img src="<?php echo $path[$row['tag']] ?>" alt="<?php echo $row['tag'] ?>" /></a>
                        <!-- 概要内容 -->
                        <p><?php echo substr(stripslashes($row['content']), 0, 50) ?></p>
                        <!-- 查看完整内容 -->
                        <ul class="actions">
                            <li><a href="view.php?ID=<?php echo $row['ID']; ?>" class="button"><?php echo iconv("utf-8", "gbk", "查看原文") ?></a></li>
                        </ul>
                    </article>
                <?php
                }
